  ...
  return (
    ...
    >
      <div className="container px-6 pt-6">
        ...
        <div className="mb-6">
          <p>
            At Dirty BIKE, we're not just in the business of selling bikes and
            gear; we're in the business of fueling a passion for cycling. Our
            journey began 2023 when a group of avid cyclists came together with
            a shared vision - to create a haven for fellow riders and
            enthusiasts, where quality, expertise, and community converge.
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-4">
          <div className="mb-6">
            <h5 className="mb-2.5 font-bold uppercase">SUPPORT</h5>
          ...
          <div className="mb-6 items-center">
            <h5 className="mb-2.5 font-bold uppercase">WE ACCEPT :</h5>

            <ul className="mb-6 list-none">
              <li className="ml-[150px] mt-2">
                <a href="/">
                  <img
                    src="https://down-ph.img.susercontent.com/file/0794511a02c35580eaf784641489f950"
                    alt=""
                  />
                </a>
              </li>
              <li className="ml-[150px] mt-2">
                <a href="/">
                  <img
                    src="https://down-ph.img.susercontent.com/file/8efc3b564e08e9e864ea83ab43d9f913"
                    alt=""
                  />
                </a>
              </li>
              <li className="ml-[150px] mt-2">
                <a href="/">
                  <img
                    src="https://down-ph.img.susercontent.com/file/91720ed84858d490ca62142de0494559"
                    alt=""
                  />
                </a>
              </li>
              <li className="ml-[150px] mt-2">
                <a href="/">
                  <img
                    src="https://down-ph.img.susercontent.com/file/4a1f1c2d9ee1820ccc9621b44f277387"
                    alt=""
                  />
                </a>
              </li>
              <li className="ml-[150px] mt-2">
                <a href="/">
                  <img
                    src="https://down-ph.img.susercontent.com/file/cf7aaa8b59e07c8548d2f03f0d930acb"
                    alt=""
                  />
                </a>
              </li>
              <li className="ml-[150px] mt-2">
                <a href="/">
                  <img
                    src="https://down-ph.img.susercontent.com/file/f01b529aae2ba30853e490e147731539"
                    alt=""
                  />
                </a>
              </li>
      ...
      <div>
        <a
          className="fixed z-50 bottom-0 right-1 mb-6 mr-6  fill-neutral-200  hover:fill-gray-600  animate-pulse"
          href="/"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
